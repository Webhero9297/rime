...
static const int VELOCITY_HEIGHT_NEW[]    = { VELOCITY_TOGGLE_NEW }; /** Height to start Velocity block 20500 */
...
static const int VELOCITY_MAX_RATE_CORRECT[]  = { BLOCK_SPACING_MAX_CORRECT }; /** Rate to Velocity in seconds */
static const int VELOCITY_RATE_CORRECT[]      = { BLOCK_SPACING_CORRECT }; /** Rate to Velocity in seconds */
static const int VELOCITY_MIN_RATE_CORRECT[]  = { BLOCK_SPACING_MIN_CORRECT }; /** Rate to Velocity in seconds */
static const int VELOCITY_MAX_RATE_CORRECT_NEW[]  = { BLOCK_SPACING_MAX_CORRECT_NEW }; /** Rate to Velocity in seconds */
static const int VELOCITY_RATE_CORRECT_NEW[]      = { BLOCK_SPACING_CORRECT_NEW }; /** Rate to Velocity in seconds */
static const int VELOCITY_MIN_RATE_CORRECT_NEW[]  = { BLOCK_SPACING_MIN_CORRECT_NEW }; /** Rate to Velocity in seconds */
