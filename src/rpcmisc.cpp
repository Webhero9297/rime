...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    if (pwalletMain) {
        ...
        if(!fLiteMode)
            obj.push_back(Pair("anonsend_balance", ValueFromAmount(pwalletMain->GetAnonymizedBalance())));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <Rime>\n"
            "Return information about <Rime>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <Rimepubkey>\n"
            "Return information about <Rimepubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <Rime> <signature> <message>\n"
