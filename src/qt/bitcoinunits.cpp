...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RIME");
    case mBTC: return QString("mRIME");
    case uBTC: return QString::fromUtf8("μRIME");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Rimes");
    case mBTC: return QString("Milli-Rimes (1 / 1,000)");
    case uBTC: return QString("Micro-Rimes (1 / 1,000,000)");
    default: return QString("???");
    }
}
